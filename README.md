...
Challenge evidence is summarized in the [signup results](docs/SIGNUP_RESULTS.md), [accessibility baseline](docs/SIGNUP_ACCESSIBILITY_BASELINE.md), and [bug report](docs/SIGNUP_BUG_REPORT.md). Assumptions and deferred cases remain explicit in the [signup test plan](docs/SIGNUP_TEST_PLAN.md).
